...
//---------------------------------------------------------------------------
    ...
    unsigned int  Cn1_1_1::order() const
        {
            return 1;
        }

    unsigned int Cn1_1_1::dimension() const
        {
            return 1;
        }

    unsigned int Cn1_1_1::nrOfPoints() const
        {
            return 1;
        }

    NumType Cn1_1_1::weight(unsigned int i) const
        {
            if (i < 1)
                return weight_[i];
            else
    ...
    void Cn1_1_1::getPoint(unsigned int i, PointReference<1>& p) const
        {
            if (i < 1)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Cn1_3_4::order() const
        {
            return 3;
        }

    unsigned int Cn1_3_4::dimension() const
        {
            return 1;
        }

    unsigned int Cn1_3_4::nrOfPoints() const
        {
            return 2;
        }

    NumType Cn1_3_4::weight(unsigned int i) const
        {
            if (i < 2)
                return weight_[i];
            else
    ...
    void Cn1_3_4::getPoint(unsigned int i, PointReference<1>& p) const
        {
            if (i < 2)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Cn1_5_9::order() const
        {
            return 5;
        }

    unsigned int Cn1_5_9::dimension() const
        {
            return 1;
        }

    unsigned int Cn1_5_9::nrOfPoints() const
        {
            return 3;
        }

    NumType Cn1_5_9::weight(unsigned int i) const
        {
            if (i < 3)
                return weight_[i];
            else
    ...
    void Cn1_5_9::getPoint(unsigned int i, PointReference<1>& p) const
        {
            if (i < 3)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  C1_7_x::order() const
        {
            return 7;
        }

    unsigned int C1_7_x::dimension() const
        {
            return 1;
        }

    unsigned int C1_7_x::nrOfPoints() const
        {
            return 4;
        }

    NumType C1_7_x::weight(unsigned int i) const
        {
            if (i < 4)
                return weight_[i];
            else
    ...
    void C1_7_x::getPoint(unsigned int i, PointReference<1>& p) const
        {
            if (i < 4)
                p=gp_[i];
            else
