...
//---------------------------------------------------------------------------
    ...
    unsigned int  TriPrism_1_1::order() const
        {
            return 1;
        }

    unsigned int TriPrism_1_1::dimension() const
        {
            return 3;
        }

    unsigned int TriPrism_1_1::nrOfPoints() const
        {
            return 1;
        }

    NumType TriPrism_1_1::weight(unsigned int i) const
        {
            if (i < 1)
                return weight_[i];
            else
    ...
    void TriPrism_1_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 1)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  TriPrism_3_1::order() const
        {
            return 3;
        }

    unsigned int TriPrism_3_1::dimension() const
        {
            return 3;
        }

    unsigned int TriPrism_3_1::nrOfPoints() const
        {
            return 8;
        }

    NumType TriPrism_3_1::weight(unsigned int i) const
        {
            if (i < 8)
                return weight_[i];
            else
    ...
    void TriPrism_3_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 8)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  TriPrism_5_1::order() const
        {
            return 5;
        }

    unsigned int TriPrism_5_1::dimension() const
        {
            return 3;
        }

    unsigned int TriPrism_5_1::nrOfPoints() const
        {
            return 21;
        }

    NumType TriPrism_5_1::weight(unsigned int i) const
        {
            if (i < 21)
                return weight_[i];
            else
    ...
    void TriPrism_5_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 21)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  TriPrism_7_1::order() const
        {
            return 7;
        }

    unsigned int TriPrism_7_1::dimension() const
        {
            return 3;
        }

    unsigned int TriPrism_7_1::nrOfPoints() const
        {
            return 64;
        }

    NumType TriPrism_7_1::weight(unsigned int i) const
        {
            if (i < 64)
                return weight_[i];
            else
    ...
    void TriPrism_7_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 64)
                p=gp_[i];
            else
