...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn2_1_1::order() const
        {
            return 1;
        }

    unsigned int Tn2_1_1::dimension() const
        {
            return 2;
        }

    unsigned int Tn2_1_1::nrOfPoints() const
        {
            return 1;
        }

    NumType Tn2_1_1::weight(unsigned int i) const
        {
            if (i < 1)
                return weight_[i];
            else
    ...
    void Tn2_1_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 1)
                p=gp_[i];
            else
    ...
    Tn2_1_1::Tn2_1_1()
     : name_("Tn2_1_1"),
       refGeoPtr_(&ReferenceTriangle::Instance())
            {
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn2_2_1::order() const
        {
            return 2;
        }

    unsigned int Tn2_2_1::dimension() const
        {
            return 2;
        }

    unsigned int Tn2_2_1::nrOfPoints() const
        {
            return 3;
        }

    NumType Tn2_2_1::weight(unsigned int i) const
        {
            if (i < 3)
                return weight_[i];
            else
    ...
    void Tn2_2_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 3)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn2_3_1::order() const
        {
            return 3;
        }

    unsigned int Tn2_3_1::dimension() const
        {
            return 2;
        }

    unsigned int Tn2_3_1::nrOfPoints() const
        {
            return 4;
        }

    NumType Tn2_3_1::weight(unsigned int i) const
        {
            if (i < 4)
                return weight_[i];
            else
    ...
    void Tn2_3_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 4)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn2_4_1::order() const
        {
            return 4;
        }

    unsigned int Tn2_4_1::dimension() const
        {
            return 2;
        }

    unsigned int Tn2_4_1::nrOfPoints() const
        {
            return 6;
        }

    NumType Tn2_4_1::weight(unsigned int i) const
        {
            if (i < 6)
                return weight_[i];
            else
    ...
    void Tn2_4_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 6)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T2_5_1::order() const
        {
            return 5;
        }

    unsigned int T2_5_1::dimension() const
        {
            return 2;
        }

    unsigned int T2_5_1::nrOfPoints() const
        {
            return 7;
        }

    NumType T2_5_1::weight(unsigned int i) const
        {
            if (i < 7)
                return weight_[i];
            else
    ...
    void T2_5_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 7)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T2_6_1::order() const
        {
            return 6;
        }

    unsigned int T2_6_1::dimension() const
        {
            return 2;
        }

    unsigned int T2_6_1::nrOfPoints() const
        {
            return 12;
        }

    NumType T2_6_1::weight(unsigned int i) const
        {
            if (i < 12)
                return weight_[i];
            else
    ...
    void T2_6_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 12)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T2_7_1::order() const
        {
            return 7;
        }

    unsigned int T2_7_1::dimension() const
        {
            return 2;
        }

    unsigned int T2_7_1::nrOfPoints() const
        {
            return 13;
        }

    NumType T2_7_1::weight(unsigned int i) const
        {
            if (i < 13)
                return weight_[i];
            else
    ...
    void T2_7_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 13)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T2_8_1::order() const
        {
            return 8;
        }

    unsigned int T2_8_1::dimension() const
        {
            return 2;
        }

    unsigned int T2_8_1::nrOfPoints() const
        {
            return 16;
        }

    NumType T2_8_1::weight(unsigned int i) const
        {
            if (i < 16)
                return weight_[i];
            else
    ...
    void T2_8_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 16)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T2_9_1::order() const
        {
            return 9;
        }

    unsigned int T2_9_1::dimension() const
        {
            return 2;
        }

    unsigned int T2_9_1::nrOfPoints() const
        {
            return 19;
        }

    NumType T2_9_1::weight(unsigned int i) const
        {
            if (i < 19)
                return weight_[i];
            else
    ...
    void T2_9_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 19)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T2_10_1::order() const
        {
            return 10;
        }

    unsigned int T2_10_1::dimension() const
        {
            return 2;
        }

    unsigned int T2_10_1::nrOfPoints() const
        {
            return 25;
        }

    NumType T2_10_1::weight(unsigned int i) const
        {
            if (i < 25)
                return weight_[i];
            else
    ...
    void T2_10_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 25)
                p=gp_[i];
            else
