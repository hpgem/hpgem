...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn3_1_1::order() const
        {
            return 1;
        }

    unsigned int Tn3_1_1::dimension() const
        {
            return 3;
        }

    unsigned int Tn3_1_1::nrOfPoints() const
        {
            return 1;
        }

    NumType Tn3_1_1::weight(unsigned int i) const
        {
            if (i < 1)
                return weight_[i];
            else
    ...
    void Tn3_1_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 1)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn3_2_1::order() const
        {
            return 2;
        }

    unsigned int Tn3_2_1::dimension() const
        {
            return 3;
        }

    unsigned int Tn3_2_1::nrOfPoints() const
        {
            return 4;
        }

    NumType Tn3_2_1::weight(unsigned int i) const
        {
            if (i < 4)
                return weight_[i];
            else
    ...
    void Tn3_2_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 4)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn3_3_1::order() const
        {
            return 3;
        }

    unsigned int Tn3_3_1::dimension() const
        {
            return 3;
        }

    unsigned int Tn3_3_1::nrOfPoints() const
        {
            return 5;
        }

    NumType Tn3_3_1::weight(unsigned int i) const
        {
            if (i < 5)
                return weight_[i];
            else
    ...
    void Tn3_3_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 5)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Tn3_4_1::order() const
        {
            return 4;
        }

    unsigned int Tn3_4_1::dimension() const
        {
            return 3;
        }

    unsigned int Tn3_4_1::nrOfPoints() const
        {
            return 11;
        }

    NumType Tn3_4_1::weight(unsigned int i) const
        {
            if (i < 11)
                return weight_[i];
            else
    ...
    void Tn3_4_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 11)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T3_5_1::order() const
        {
            return 5;
        }

    unsigned int T3_5_1::dimension() const
        {
            return 3;
        }

    unsigned int T3_5_1::nrOfPoints() const
        {
            return 14;
        }

    NumType T3_5_1::weight(unsigned int i) const
        {
            if (i < 14)
                return weight_[i];
            else
    ...
    void T3_5_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 14)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T3_6_1::order() const
        {
            return 6;
        }

    unsigned int T3_6_1::dimension() const
        {
            return 3;
        }

    unsigned int T3_6_1::nrOfPoints() const
        {
            return 24;
        }

    NumType T3_6_1::weight(unsigned int i) const
        {
            if (i < 24)
                return weight_[i];
            else
    ...
    void T3_6_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 24)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T3_7_1::order() const
        {
            return 7;
        }

    unsigned int T3_7_1::dimension() const
        {
            return 3;
        }

    unsigned int T3_7_1::nrOfPoints() const
        {
            return 31;
        }

    NumType T3_7_1::weight(unsigned int i) const
        {
            if (i < 31)
                return weight_[i];
            else
    ...
    void T3_7_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 31)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T3_8_1::order() const
        {
            return 8;
        }

    unsigned int T3_8_1::dimension() const
        {
            return 3;
        }

    unsigned int T3_8_1::nrOfPoints() const
        {
            return 43;
        }

    NumType T3_8_1::weight(unsigned int i) const
        {
            if (i < 43)
                return weight_[i];
            else
    ...
    void T3_8_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 43)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T3_9_1::order() const
        {
            return 9;
        }

    unsigned int T3_9_1::dimension() const
        {
            return 3;
        }

    unsigned int T3_9_1::nrOfPoints() const
        {
            return 53;
        }

    NumType T3_9_1::weight(unsigned int i) const
        {
            if (i < 53)
                return weight_[i];
            else
    ...
    void T3_9_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 53)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  T3_10_1::order() const
        {
            return 10;
        }

    unsigned int T3_10_1::dimension() const
        {
            return 3;
        }

    unsigned int T3_10_1::nrOfPoints() const
        {
            return 126;
        }

    NumType T3_10_1::weight(unsigned int i) const
        {
            if (i < 126)
                return weight_[i];
            else
    ...
    void T3_10_1::getPoint(unsigned int i, PointReference<3>& p) const
        {
            if (i < 126)
                p=gp_[i];
            else
