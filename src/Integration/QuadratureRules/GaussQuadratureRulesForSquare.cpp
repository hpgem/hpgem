...
//---------------------------------------------------------------------------
    ...
    unsigned int  Cn2_1_1::order() const
        {
            return 1;
        }

    unsigned int Cn2_1_1::dimension() const
        {
            return 2;
        }

    unsigned int Cn2_1_1::nrOfPoints() const
        {
            return 1;
        }

    NumType Cn2_1_1::weight(unsigned int i) const
        {
            if (i < 1)
                return weight_[i];
            else
    ...
    void Cn2_1_1::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 1)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Cn2_3_4::order() const
        {
            return 3;
        }

    unsigned int Cn2_3_4::dimension() const
        {
            return 2;
        }

    unsigned int Cn2_3_4::nrOfPoints() const
        {
            return 4;
        }

    NumType Cn2_3_4::weight(unsigned int i) const
        {
            if (i < 4)
                return weight_[i];
            else
    ...
    void Cn2_3_4::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 4)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  Cn2_5_9::order() const
        {
            return 5;
        }

    unsigned int Cn2_5_9::dimension() const
        {
            return 2;
        }

    unsigned int Cn2_5_9::nrOfPoints() const
        {
            return 9;
        }

    NumType Cn2_5_9::weight(unsigned int i) const
        {
            if (i < 9)
                return weight_[i];
            else
    ...
    void Cn2_5_9::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 9)
                p=gp_[i];
            else
...
//---------------------------------------------------------------------------
    ...
    unsigned int  C2_7_4::order() const
        {
            return 7;
        }

    unsigned int C2_7_4::dimension() const
        {
            return 2;
        }

    unsigned int C2_7_4::nrOfPoints() const
        {
            return 16;
        }

    NumType C2_7_4::weight(unsigned int i) const
        {
            if (i < 16)
                return weight_[i];
            else
    ...
    void C2_7_4::getPoint(unsigned int i, PointReference<2>& p) const
        {
            if (i < 16)
                p=gp_[i];
            else
