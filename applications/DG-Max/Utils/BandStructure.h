...
public:
    ...
    public:
        ...
        virtual double frequency(std::size_t line, double interpolation) const = 0;
        ...
        virtual int lineType(std::size_t line) const
        {
            return -1;
        }
    ...
    virtual std::unique_ptr<LineSet> computeLines(LinearAlgebra::SmallVector<DIM> point1,
