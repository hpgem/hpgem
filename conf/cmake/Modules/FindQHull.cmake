...
if(QHULL_USE_STATIC)
    ...
    set(QHULL_CPP_NAME qhullcpp qhull${QHULL_MAJOR_VERSION}cpp qhullcpp${QHULL_MAJOR_VERSION})
    set(QHULL_DEBUG_NAME qhull_d qhull${QHULL_MAJOR_VERSION}_d qhull_d${QHULL_MAJOR_VERSION})
    set(QHULL_CPP_DEBUG_NAME qhullcpp_d qhull${QHULL_MAJOR_VERSION}cpp_d qhullcpp_d${QHULL_MAJOR_VERSION})
...
find_library(QHULL_LIBRARY_CPP_DEBUG
NAMES ${QHULL_CPP_DEBUG_NAME} ${QHULL_CPP_NAME}
HINTS "${QHULL_ROOT}" "$ENV{QHULL_ROOT}"
PATHS "$ENV{PROGRAMFILES}/QHull" "$ENV{PROGRAMW6432}/QHull"
PATH_SUFFIXES project build bin lib)
if(NOT QHULL_LIBRARY_CPP_DEBUG)
    set(QHULL_LIBRARY_CPP_DEBUG ${QHULL_CPP_LIBRARY})
endif(NOT QHULL_LIBRARY_CPP_DEBUG)
set(QHULL_INCLUDE_DIRS ${QHULL_INCLUDE_DIR})
set(QHULL_LIBRARIES ${QHULL_CPP_LIBRARY})
set(QHULL_DEBUG_LIBRARIES ${QHULL_LIBRARY_CPP_DEBUG})
include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Qhull DEFAULT_MSG QHULL_CPP_LIBRARY QHULL_INCLUDE_DIR)
mark_as_advanced(QHULL_LIBRARY QHULL_LIBRARY_DEBUG QHULL_INCLUDE_DIR QHULL_CPP_LIBRARY QHULL_LIBRARY_CPP_DEBUG)
if(QHULL_FOUND)
    set(HAVE_QHULL ON)
