...
int main()
{
  ...
  // 1D basis functions------------------------------------------------
  Base::BaseBasisFunction::PointReferenceT p1(1);
  p1[0] = .5;

  order = 1;
  Base::BasisFunctionSet BFset1(order);
  ...
  // 2D basis functions------------------------------------------------
  Base::BaseBasisFunction::PointReferenceT p2(2);
  p2[0] = .5;  p2[1] = .3;

  order = 1;
  Base::BasisFunctionSet BFset2(order);
  ...
  order = 2;
  Base::BasisFunctionSet BFset3(order);
  ...
  // 3D basis functions------------------------------------------------
  Base::BaseBasisFunction::PointReferenceT p3(3);
  p3[0] = .5;  p3[1] = .3;  p3[1] = .75;

  order = 2;
  Base::BasisFunctionSet BFset4(order);
  ...
  order = 2;
  Base::BasisFunctionSet BFset5(order);
