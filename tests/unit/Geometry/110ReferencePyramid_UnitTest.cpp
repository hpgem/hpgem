/*
 * 110ReferencePyramid_UnitTest.cpp
 *
...
int main(){
	...
	assert(("getLocalNodeIndex 0",test.getLocalNodeIndex(0,3)==2));//and only face nodes are specified and the ordering of the nodes is consistent
	assert(("getLocalNodeIndex 1",test.getLocalNodeIndex(1,0)==3));//across function calls
	assert(("getLocalNodeIndex 1",test.getLocalNodeIndex(1,1)==1));
	assert(("getLocalNodeIndex 1",test.getLocalNodeIndex(1,2)==0));
	assert(("getLocalNodeIndex 2",test.getLocalNodeIndex(2,0)==2));
	assert(("getLocalNodeIndex 2",test.getLocalNodeIndex(2,1)==4));
	assert(("getLocalNodeIndex 2",test.getLocalNodeIndex(2,2)==0));
	assert(("getLocalNodeIndex 3",test.getLocalNodeIndex(3,0)==1));
	assert(("getLocalNodeIndex 3",test.getLocalNodeIndex(3,1)==2));
	assert(("getLocalNodeIndex 3",test.getLocalNodeIndex(3,2)==0));
	assert(("getLocalNodeIndex 4",test.getLocalNodeIndex(4,0)==4));
	...
	std::vector<unsigned int> faceIndices(4);
	//codim0maps dont exist so they dont need to be found properly


	assert(("higher codimensional entities",test.getNrOfCodim1Entities()==5&&test.getNrOfCodim2Entities()==8)&&test.getNrOfCodim3Entities()==5);
	assert(("getCodim1ReferenceGeometry",test.getCodim1ReferenceGeometry(0)==&Geometry::ReferenceSquare::Instance()&&
										 ...
										 test.getCodim1ReferenceGeometry(4)==&Geometry::ReferenceTriangle::Instance()));
	...
	assert(("getCodim1MappingPtr",test.getCodim1MappingPtr(0)==&Geometry::MappingToRefFaceToPyramid0::Instance()));
	assert(("getCodim1MappingPtr",test.getCodim1MappingPtr(1)==&Geometry::MappingToRefFaceToPyramid1::Instance()));
	assert(("getCodim1MappingPtr",test.getCodim1MappingPtr(2)==&Geometry::MappingToRefFaceToPyramid2::Instance()));
	assert(("getCodim1MappingPtr",test.getCodim1MappingPtr(3)==&Geometry::MappingToRefFaceToPyramid3::Instance()));
	assert(("getCodim1MappingPtr",test.getCodim1MappingPtr(4)==&Geometry::MappingToRefFaceToPyramid4::Instance()));
	...
	assert(("number of nodes",test.getNumberOfNodes()==5));
	assert(("type of geometry",test.getGeometryType()==Geometry::PYRAMID));
