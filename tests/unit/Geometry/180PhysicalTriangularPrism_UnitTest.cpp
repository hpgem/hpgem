/*
 * 180PhysicalTriangularPrism_UnitTest.cpp
 *
...
int main(){
	...
	assert(("getNodeIndexes",pointIndexes[0]==4&&pointIndexes[1]==7&&pointIndexes[2]==10&&
						   pointIndexes[3]==11&&pointIndexes[4]==12&&pointIndexes[5]==13));
	...
	assert(("getNodeIndex",test.getNodeIndex(0)==4&&test.getNodeIndex(1)==7&&test.getNodeIndex(2)==10&&
						 test.getNodeIndex(3)==11&&test.getNodeIndex(4)==12&&test.getNodeIndex(5)==13));
	...
	assert(("getNumberOfNodes",test.getNumberOfNodes()==6));
	...
	assert(("getRefGeometry",test.getRefGeometry()==&Geometry::ReferenceTriangularPrism::Instance()));
