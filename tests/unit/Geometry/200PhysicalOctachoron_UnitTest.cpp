/*
 * 200PhysicalOctochoron_UnitTest.cpp
 *
...
int main(){
	...
	assert(("getNodePtr",fabs(point[3]-1.)<1e-12));
	...
	assert(("getNodeCoordinates",fabs(point[3]-1.)<1e-12));
	...
	assert(("getNodeCoordinates",fabs(point[1]-2.4)<1e-12));
	assert(("getNodeCoordinates",fabs(point[2]-5.4)<1e-12));
	assert(("getNodeCoordinates",fabs(point[3]-2.)<1e-12));
	...
	assert(("getNodeCoordinates",fabs(point[1]-2.4)<1e-12));
	assert(("getNodeCoordinates",fabs(point[2]-5.4)<1e-12));
	assert(("getNodeCoordinates",fabs(point[3]-3.)<1e-12));
	...
	assert(("getNodeCoordinates",fabs(point[1]-2.4)<1e-12));
	assert(("getNodeCoordinates",fabs(point[2]-5.4)<1e-12));
	assert(("getNodeCoordinates",fabs(point[3]-4.)<1e-12));
	...
	assert(("getLocalNodeCoordinates",fabs(point[3]-1.)<1e-12));
	...
	assert(("getLocalNodeCoordinates",fabs(point[1]-2.4)<1e-12));
	assert(("getLocalNodeCoordinates",fabs(point[2]-5.4)<1e-12));
	assert(("getLocalNodeCoordinates",fabs(point[3]-2.)<1e-12));
	...
	for(double i=0;i<10;++i){
		...
		assert(("getGlobalNodeCoordinates",fabs(point[3]-1.)<1e-12));
	}
