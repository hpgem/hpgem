...
void FunctionCache::getFunctionValuesVector(const Base::Element< 3 >* element, const PointElementReferenceT& point, std::vector< NumericalVector >& values){
...
void FunctionCache::getFunctionCurlsVector(const Base::Element< 3 >* element, const PointElementReferenceT& point, std::vector< NumericalVector >& curls){
...
ElementInfos::ElementInfos(const Base::Element< 3 >& element){
    PointElementReferenceT p;
    Geometry::PointPhysical<3> pPhys;
...
void ElementInfos::makeFunctionValuesVector(const Base::Element< 3 >* element, const PointElementReferenceT& point, std::vector< NumericalVector >& values){
...
void ElementInfos::makeFunctionCurlsVector(const Base::Element< 3 >* element, const PointElementReferenceT& point, std::vector< NumericalVector >& curls){
